...
public class BleGattExecutor extends BluetoothGattCallback {
    ...
    // Constants
    private static String CHARACTERISTIC_CONFIG = "00002902-0000-1000-8000-0085f9b34fb"; // TODO: what does this mean?

    public interface ServiceAction {
        ServiceAction NULL = new ServiceAction() {
            @Override
            public boolean execute(BluetoothGatt bluetoothGatt){
                // this is the null action. do nothing
                return true;
            }
        };
         ...
         * Executes action
         *
         * @param bluetoothGatt the gatt to execute
         * @return true if action was executed instantly. false if action waiting for feedback
         */
        boolean execute(BluetoothGatt bluetoothGatt); // TODO: what does this mean?
    }
